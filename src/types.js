...
export const FETCH_PARTNER_STAT_PROPOSALS_PASS = 'FETCH_PARTNER_STAT_PROPOSALS_PASS'
export const FETCH_PARTNER_STAT_PROPOSALS_FAIL = 'FETCH_PARTNER_STAT_PROPOSALS_FAIL'
export const FETCH_PARTNER_STAT_PROPOSALS_START = 'FETCH_PARTNER_STAT_PROPOSALS_START'
export const UPDATE_PARTNER_STAT_COMMENT = 'UPDATE_PARTNER_STAT_COMMENT'
export const SUBMIT_PARTNER_STAT_COMMENT_START = 'SUBMIT_PARTNER_STAT_COMMENT_START'
export const SUBMIT_PARTNER_STAT_COMMENT_FAIL = 'SUBMIT_PARTNER_STAT_COMMENT_FAIL'
export const SUBMIT_PARTNER_STAT_COMMENT_PASS = 'SUBMIT_PARTNER_STAT_COMMENT_PASS'

export const FETCH_PARTNER_STAT1_PROPOSALS_PASS = 'FETCH_PARTNER_STAT1_PROPOSALS_PASS'
export const FETCH_PARTNER_STAT1_PROPOSALS_FAIL = 'FETCH_PARTNER_STAT1_PROPOSALS_FAIL'
export const FETCH_PARTNER_STAT1_PROPOSALS_START = 'FETCH_PARTNER_STAT1_PROPOSALS_START'

export const TOTAL_PARTNER_STAT_OBSERVATION = 'TOTAL_PARTNER_STAT_OBSERVATION'

export const FETCH_PARTNER_SHARE_TIMES_PASS = 'FETCH_PARTNER_SHARE_TIMES_PASS'
export const FETCH_PARTNER_SHARE_TIMES_FAIL = 'FETCH_PARTNER_SHARE_TIMES_FAIL'
export const FETCH_PARTNER_SHARE_TIMES_START = 'FETCH_PARTNER_SHARE_TIMES_START'

export const FETCH_TIME_BREAKDOWN_START = 'FETCH_TIME_BREAKDOWN_START'
export const FETCH_TIME_BREAKDOWN_PASS = 'FETCH_TIME_BREAKDOWN_PASS'
export const FETCH_TIME_BREAKDOWN_FAIL = 'FETCH_TIME_BREAKDOWN_FAIL'

export const FETCH_STATISTICS_START = 'FETCH_STATISTICS_START'
export const FETCH_STATISTICS_PASS = 'FETCH_STATISTICS_PASS'
...
export const FETCH_PARTNER_AVAILABLE_TIME_PASS = 'FETCH_PARTNER_AVAILABLE_TIME_PASS'
...
export const UPDATE_MEMBER = 'MAKE_CHAIR'
