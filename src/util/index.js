...
export function areAllocatedTimesCorrect(partner, availableTime, proposals){
	...
	return {
		p0p1: allocTotals.p0 + allocTotals.p1 <= (availableTime.p0p1) *60*60+300,
		p2: allocTotals.p2 <= availableTime.p2*60*60+300,
		p3: allocTotals.p3 <= availableTime.p3*60*60+300,
	}
